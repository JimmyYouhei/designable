...
const LocalesContainer: FC<{ children: ReactNode }> = (props) => {
  const getIntl = useCallback(() => {
    ...
    localeMessages['$internal.edit.link'] = "https://github.com/alibaba/designable/edit/main/{filename}";

    localeMessages['$internal.api.sourceLink'] = "https://github.com/alibaba/designable/tree/main/{fileName}#L{line}";
