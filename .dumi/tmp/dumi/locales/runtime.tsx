...
import { RawIntlProvider, createIntl, createIntlCache } from 'D:/Github/designable/node_modules/react-intl';
import { useIsomorphicLayoutEffect } from 'D:/Github/designable/node_modules/dumi/dist/client/theme-api/utils.js'
...
const LocalesContainer: FC<{ children: ReactNode }> = (props) => {
  const getIntl = useCallback(() => {
    ...
    localeMessages['$internal.edit.link'] = "https://github.com/alibaba/designable/edit/quan_upgrade/{filename}";

    localeMessages['$internal.api.sourceLink'] = "https://github.com/alibaba/designable/tree/quan_upgrade/{fileName}#L{line}";
